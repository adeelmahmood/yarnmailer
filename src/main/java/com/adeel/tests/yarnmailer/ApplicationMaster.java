...
public class ApplicationMaster {
	...
	public boolean run() throws IOException, YarnException {
		...
		String suffix = appName + Path.SEPARATOR + appAttemptId.getApplicationId() + Path.SEPARATOR + "Containers.jar";
		Path dest = new Path(fs.getHomeDirectory(), suffix);
		fs.copyFromLocalFile(new Path("AppMaster.jar"), dest);
	...
	private class LaunchContainerRunnable implements Runnable {
		...
		public void run() {
			...
			// // set classname
			vargs.add("com.adeel.tests.yarnmailer.Mailer");
